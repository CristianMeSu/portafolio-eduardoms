/* ==========================================================================
   JAVASCRIPT PORTFOLIO EDUARDO MENDOZA SUÁREZ
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const words = [
    "Director Regional de Revenue Management",
    "Modelado de Demanda No Restringida",
    "Estratega de Precios & Total Revenue",
    "Business Intelligence & IA Aplicada",
  ];
  let wordIndex = 0;
  let charIndex = 0;
